...
<script language="javascript">
	function logon(){
		var result=confirm("你确定保存用户名和密吗?");
		if(result){
...
<div id="header">
  <div id="top_login">
  	...
  	<c:if test="${empty sessionScope.u}" >
		    ...
		    <img src="image" width="80" height="24" onclick="refreshImage(this)" alt="点击刷新" style="cursor:hand;" />
		    <input type="submit" class="login_sub" value="登录" onclick="logon()"/>
		    <label id="error" style="color:red">${requestScope.error } </label>
		    <img src="Images/friend_logo.gif" alt="Google" id="friend_logo" /> 
		    </form>
	</c:if>
	<c:if test="${not empty sessionScope.u}" >
	  		欢迎你,<font color="red">${sessionScope.u.userName}</font>
	  				<a href="admin/news?method=newsList">进入后台管理界面</a>	
  	</c:if>
  	本网站的登陆次数为:<font color="red">${applicationScope.count}</font>
...
<div id="container">
  <div class="sidebar">
    <p> <img src="Images/title_1.gif" alt="国内新闻" /> </p>
    <div class="side_list">
      <ul>
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <ul class="classlist">
      <li><a href='newspages/news_read.html'> 深足教练组：说我们买球是侮辱 朱广沪常暗中支招 </a><span> 2009-10-28 01:03:51.0 </span></li>
